...
-- Volcando estructura de base de datos para desis
CREATE DATABASE IF NOT EXISTS `desis` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `desis`;

-- Volcando estructura para tabla desis.candidatos
...
-- Volcando datos para la tabla desis.candidatos: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla desis.comunas
...
-- Volcando datos para la tabla desis.comunas: 346 rows
DELETE FROM `comunas`;
...
-- Volcando estructura para tabla desis.provincias
...
-- Volcando datos para la tabla desis.provincias: 56 rows
...
-- Volcando estructura para tabla desis.regiones
...
-- Volcando datos para la tabla desis.regiones: 16 rows
...
-- Volcando estructura para tabla desis.votante
CREATE TABLE IF NOT EXISTS `votante` (
  ...
  `redes_sociales` tinyint(1) DEFAULT '0',
  `amigo` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `candidato_id` (`candidato_id`),
  CONSTRAINT `votante_ibfk_1` FOREIGN KEY (`candidato_id`) REFERENCES `candidatos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla desis.votante: ~0 rows (aproximadamente)
DELETE FROM `votante`;
